  ...
  <div id="app">
    ...
    <header>
      <div class="header-container">
        <!-- <h1>EduShare</h1> -->
        <div class="navbar-logo"><span>🎓</span> EduShare</div>
        <nav>
...
export default {
  ...
  methods: {
    validateForm() {
      ...
      if (!this.form.resourceType) this.errors.resourceType = 'Resource Type is required.'
      if (!this.form.priority) this.errors.priority = 'Priority is required.'
      if (!this.form.quantity) this.errors.quantity = 'Quantity is required.'
    ...
    confirmRequest() {
      if (this.validateForm()) {
        // Save form data to localStorage or Vuex store if needed
        localStorage.setItem('requestData', JSON.stringify(this.form))
